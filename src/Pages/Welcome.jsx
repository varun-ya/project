...
function Welcome() {
  ...
  return (
    <div>
      ...
      >
        <div className="grid content-center h-full justify-items-center"> {/* Removed duplicate justify-center */}
          <div className="w-10/12 text-center sm:w-11/12 md:w-40rem">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
              ...
              <h1 className="mb-4 text-xl text-center text-stone-400 font-light sm:text-2xl">
                Watch anywhere. Cancel anytime {/* Fixed typo */}
              </h1>
          ...
          <div className="flex justify-center md:py-8">
            <div className="lg:flex lg:items-center lg:w-9/12">
              ...
              <div className="flex justify-center">
                <img alt="TV display" src={WelcomePageImage1} /> {/* Added alt attribute */}
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
          <div className="flex justify-center">
            <div className="flex flex-col-reverse lg:flex-row lg:items-center lg:w-9/12">
              <div className="flex justify-center">
                <img alt="Download shows" src={WelcomePageImage2} /> {/* Added alt attribute */}
              </div>
              <div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
          <div className="flex justify-center md:py-8">
            <div className="lg:flex lg:items-center lg:w-9/12">
              ...
              <div className="flex justify-center">
                <img alt="Watch everywhere" src={WelcomePageImage3} /> {/* Added alt attribute */}
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <section className="bg-black">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
          <div className="flex justify-center">
            <div className="flex flex-col-reverse lg:flex-row lg:items-center lg:w-9/12">
              <div className="flex justify-center">
                <img alt="Children profiles" src={WelcomePageImage4} /> {/* Added alt attribute */}
              </div>
              <div>
                <h1 className="mt-4 mb-6 text-4xl font-semibold text-center text-white lg:mt-0 lg:text-left lg:ml-8 lg:text-5xl xl:text-6xl">
